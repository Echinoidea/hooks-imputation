...
aqi_countries <- data.frame(fread(file = "./data/AIR QUALITY INDEX-top countries.csv", drop = "Rank"))
...
colnames(aqi_cities) <- c("City", "X2021", "X2021Jan", "X2021Feb", "X2021Mar", 
                          ...
                          "X2019", "X2018", "X2017")
colnames(aqi_countries) <- c("Country.Region", "X2021", "X2020", "X2019", "X2018", "Pop")
...
imputation.mean <- function(x, row.range = 1:nrow(x), col.range = 1:ncol(x)) {
  imputed <- x
